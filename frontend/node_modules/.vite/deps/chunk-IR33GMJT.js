...
// node_modules/react-pivottable/Utilities.js
var require_Utilities = __commonJS({
  "node_modules/react-pivottable/Utilities.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.PivotData = exports.sortAs = exports.getSort = exports.numberFormat = exports.naturalSort = exports.locales = exports.derivers = exports.aggregators = exports.aggregatorTemplates = void 0;
    ...
    var addSeparators = function addSeparators2(nStr, thousandsSep, decimalSep) {
    ...
    var numberFormat = function numberFormat2(opts_in) {
      var defaults = {
    ...
    var rd = /\d/;
    var rz = /^0/;
    var naturalSort = function naturalSort2(as, bs) {
      if (bs !== null && as === null) {
        return -1;
      }
      if (as !== null && bs === null) {
    ...
    var sortAs = function sortAs2(order) {
      var mapping = {};
      var l_mapping = {};
      for (var i in order) {
        var x = order[i];
    ...
    var getSort = function getSort2(sorters, attr) {
      if (sorters) {
    ...
    var aggregatorTemplates = {
      count: function count() {
        var formatter = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : usFmtInt;
        return function() {
          return function() {
            return {
              count: 0,
      ...
      uniques: function uniques(fn) {
        var formatter = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : usFmtInt;
        return function(_ref) {
          var _ref2 = _slicedToArray(_ref, 1), attr = _ref2[0];
          return function() {
            return {
              uniq: [],
      ...
      sum: function sum() {
        var formatter = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : usFmt;
        return function(_ref3) {
          var _ref4 = _slicedToArray(_ref3, 1), attr = _ref4[0];
          return function() {
            return {
              sum: 0,
              push: function push(record) {
      ...
      extremes: function extremes(mode) {
        var formatter = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : usFmt;
        return function(_ref5) {
          var _ref6 = _slicedToArray(_ref5, 1), attr = _ref6[0];
      ...
      quantile: function quantile(q) {
        ...
        return function(_ref7) {
          var _ref8 = _slicedToArray(_ref7, 1), attr = _ref8[0];
          return function() {
            return {
              vals: [],
              push: function push(record) {
      ...
      runningStat: function runningStat() {
        var mode = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "mean";
        var ddof = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1;
        var formatter = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : usFmt;
        return function(_ref9) {
          var _ref10 = _slicedToArray(_ref9, 1), attr = _ref10[0];
          return function() {
            return {
              n: 0,
              m: 0,
      ...
      sumOverSum: function sumOverSum() {
        ...
        return function(_ref11) {
          var _ref12 = _slicedToArray(_ref11, 2), num = _ref12[0], denom = _ref12[1];
          return function() {
            return {
              sumNum: 0,
              sumDenom: 0,
      ...
      fractionOf: function fractionOf(wrapped) {
        var type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "total";
        var formatter = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : usFmtPct;
        return function() {
    ...
    var zeroPad = function zeroPad2(number) {
    ...
    var derivers = {
      ...
      dateFormat: function dateFormat(col, formatString) {
        var utcOutput = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
        var mthNames = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : mthNamesEn;
        var dayNames = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : dayNamesEn;
    ...
    var PivotData = function() {
      function PivotData2() {
        ...
        _classCallCheck(this, PivotData2);
        this.props = Object.assign({}, PivotData2.defaultProps, inputProps);
        _propTypes2.default.checkPropTypes(PivotData2.propTypes, this.props, "prop", "PivotData");
        ...
        this.sorted = false;
        PivotData2.forEachRecord(this.props.data, this.props.derivedAttributes, function(record) {
          if (_this.filter(record)) {
            _this.processRecord(record);
          }
        });
      }
      _createClass(PivotData2, [{
        key: "filter",
        ...
        value: function forEachMatchingRecord(criteria, callback) {
          var _this2 = this;
          return PivotData2.forEachRecord(this.props.data, this.props.derivedAttributes, function(record) {
          ...
          return function(a2, b) {
            ...
            try {
              for (var _iterator2 = Object.keys(sortersArr || {})[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                var comparison = sorter(a2[i], b[i]);
                if (comparison !== 0) {
                  return comparison;
                }
              }
...
//# sourceMappingURL=chunk-IR33GMJT.js.map
