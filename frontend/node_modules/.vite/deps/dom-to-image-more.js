  ...
  "node_modules/dom-to-image-more/dist/dom-to-image-more.min.js"(exports, module) {
    ((l) => {
      ...
      let i = { copyDefaultStyles: true, imagePlaceholder: void 0, cacheBust: false, useCredentials: false, useCredentialsFilters: [], httpTimeout: 3e4, styleCaching: "strict", corsImg: void 0, adjustClonedNode: void 0, filterStyles: void 0 }, d = { toSvg: u, toPng: function(e2, t2) {
        ...
        return a(e2, t2).then(f.canvasToBlob);
      ...
      }, toCanvas: a, impl: { fontFaces: e, images: n, util: f, inliner: r, urlCache: [], options: {}, copyOptions: function(e2) {
      ...
      function u(t2, r2) {
        let n2 = d.impl.util.getWindow(t2), i2 = (r2 = r2 || {}, d.impl.copyOptions(r2), []);
        return Promise.resolve(t2).then(function(e2) {
          if (e2.nodeType === m) return e2;
          var t3 = e2, n3 = e2.parentNode, o2 = document.createElement("span");
          return n3.replaceChild(o2, t3), o2.append(e2), i2.push({ parent: n3, child: t3, wrapper: o2 }), o2;
        }).then(function(e2) {
          return function l2(t3, s2, i3, u2) {
            let e3 = s2.filter;
            if (t3 === p || f.isHTMLScriptElement(t3) || f.isHTMLStyleElement(t3) || f.isHTMLLinkElement(t3) || null !== i3 && e3 && !e3(t3)) return Promise.resolve();
            return Promise.resolve(t3).then(n3).then(o2).then(function(e4) {
              return c2(e4, a2(t3));
            }).then(r3).then(function(e4) {
              return d2(e4, t3);
            });
            function n3(e4) {
              return f.isHTMLCanvasElement(e4) ? f.makeImage(e4.toDataURL()) : e4.cloneNode(false);
            }
            function o2(e4) {
            ...
            function a2(e4) {
              return f.isElementHostForOpenShadowRoot(e4) ? e4.shadowRoot : e4;
            }
            function c2(n4, e4) {
              let o3 = t4(e4), r4 = Promise.resolve();
              if (0 !== o3.length) {
                let t5 = h(i4(e4));
                f.asArray(o3).forEach(function(e5) {
                  r4 = r4.then(function() {
              ...
              function i4(e5) {
                return f.isShadowRoot(e5) ? e5.host : e5;
              }
              function t4(t5) {
            ...
            function d2(u3, a3) {
              return !f.isElement(u3) || f.isShadowSlotElement(a3) ? Promise.resolve(u3) : Promise.resolve().then(t4).then(n4).then(o3).then(r4).then(e4).then(function() {
                return u3;
              });
              function e4() {
                f.isHTMLImageElement(u3) && (u3.removeAttribute("loading"), a3.srcset || a3.sizes) && (u3.removeAttribute("srcset"), u3.removeAttribute("sizes"), u3.src = a3.currentSrc || a3.src);
              }
              function t4() {
                function o4(e6, t5) {
                ...
                function e5(e6, t5) {
                  let n5 = h(e6);
                  n5.cssText ? (t5.style.cssText = n5.cssText, o4(n5, t5.style)) : (y(s2, e6, n5, i3, t5), null === i3 && (["inset-block", "inset-block-start", "inset-block-end"].forEach((e7) => t5.style.removeProperty(e7)), ["left", "right", "top", "bottom"].forEach((e7) => {
              ...
              function n4() {
                let s3 = f.uid();
                function t5(r5) {
                  let i4 = h(a3, r5), l3 = i4.getPropertyValue("content");
                  if ("" !== l3 && "none" !== l3) {
                    let n6 = function() {
                      let e6 = `.${s3}:` + r5, t7 = (i4.cssText ? n7 : o4)();
                      return document.createTextNode(e6 + `{${t7}}`);
                      function n7() {
                        return `${i4.cssText} content: ${l3};`;
                      }
                      function o4() {
                        let e7 = f.asArray(i4).map(t8).join("; ");
                        return e7 + ";";
                        function t8(e8) {
                          let t9 = i4.getPropertyValue(e8), n8 = i4.getPropertyPriority(e8) ? " !important" : "";
                          return e8 + ": " + t9 + n8;
                        }
                      }
                    };
              ...
              function r4() {
                f.isSVGElement(u3) && (u3.setAttribute("xmlns", "http://www.w3.org/2000/svg"), f.isSVGRectElement(u3)) && ["width", "height"].forEach(function(e5) {
          ...
          let n3 = r2.width || f.width(t2), o2 = r2.height || f.height(t2);
          ...
          }).then(f.escapeXhtml).then(function(e3) {
            var t3 = (f.isDimensionMissing(n3) ? ' width="100%"' : ` width="${n3}"`) + (f.isDimensionMissing(o2) ? ' height="100%"' : ` height="${o2}"`);
            return `<svg xmlns="http://www.w3.org/2000/svg"${(f.isDimensionMissing(n3) ? "" : ` width="${n3}"`) + (f.isDimensionMissing(o2) ? "" : ` height="${o2}"`)}><foreignObject${t3}>${e3}</foreignObject></svg>`;
          }).then(function(e3) {
      ...
      function a(r2, i2) {
        return u(r2, i2 = i2 || {}).then(f.makeImage).then(function(e2) {
