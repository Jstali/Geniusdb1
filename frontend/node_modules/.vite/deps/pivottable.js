...
var require_pivot = __commonJS({
  "node_modules/pivottable/dist/pivot.js"(exports, module) {
    (function() {
      var callWithJQuery, indexOf = [].indexOf || function(item) {
      ...
      callWithJQuery = function(pivotModule) {
        if (typeof exports === "object" && typeof module === "object") {
          return pivotModule(require_jquery());
      ...
      callWithJQuery(function($) {
        ...
        rd = /\d/;
        rz = /^0/;
        naturalSort = /* @__PURE__ */ function(_this) {
        ...
        PivotData = function() {
          function PivotData2(input, opts) {
            ...
            this.sorted = false;
            PivotData2.forEachRecord(this.input, this.derivedAttributes, /* @__PURE__ */ function(_this) {
              return function(record) {
          ...
          PivotData2.forEachRecord = function(input, derivedAttributes, f) {
            ...
            if ($.isEmptyObject(derivedAttributes)) {
              ...
              addRecord = function(record2) {
                var k2, ref2, v;
                for (k2 in derivedAttributes) {
                  v = derivedAttributes[k2];
                  record2[k2] = (ref2 = v(record2)) != null ? ref2 : record2[k2];
                }
                return f(record2);
              };
            }
            if ($.isFunction(input)) {
              ...
              tblCols = [];
              $("thead > tr > th", input).each(function(i2) {
                return tblCols.push($(this).text());
              });
              return $("tbody > tr", input).each(function(i2) {
                record = {};
                $("td", this).each(function(j2) {
                  return record[tblCols[j2]] = $(this).text();
                });
          ...
          PivotData2.prototype.forEachMatchingRecord = function(criteria, callback) {
            return PivotData2.forEachRecord(this.input, this.derivedAttributes, /* @__PURE__ */ function(_this) {
              return function(record) {
                var k, ref, v;
                if (!_this.filter(record)) {
                  return;
          ...
          PivotData2.prototype.sortKeys = function() {
            ...
            if (!this.sorted) {
              ...
              switch (this.rowOrder) {
                case "value_a_to_z":
                  this.rowKeys.sort(/* @__PURE__ */ function(_this) {
                    return function(a, b) {
              ...
              switch (this.colOrder) {
                case "value_a_to_z":
                  return this.colKeys.sort(/* @__PURE__ */ function(_this) {
                    return function(a, b) {
                      return naturalSort(v([], a), v([], b));
                    };
                  }(this));
          ...
          PivotData2.prototype.processRecord = function(record) {
        ...
        pivotTableRenderer = function(pivotData, opts) {
          ...
          if (opts.table.clickCallback) {
            getClickHandler = function(value, rowValues, colValues) {
              ...
              filters = {};
              for (i2 in colAttrs) {
                if (!hasProp.call(colAttrs, i2)) continue;
                attr = colAttrs[i2];
                if (colValues[i2] != null) {
                  filters[attr] = colValues[i2];
                }
              }
              for (i2 in rowAttrs) {
                if (!hasProp.call(rowAttrs, i2)) continue;
                attr = rowAttrs[i2];
                if (rowValues[i2] != null) {
                  filters[attr] = rowValues[i2];
                }
              }
              return function(e) {
          ...
          spanSize = function(arr, i2, j2) {
            var l, len, n, noDraw, ref, ref1, stop, x2;
            if (i2 !== 0) {
              noDraw = true;
              for (x2 = l = 0, ref = j2; 0 <= ref ? l <= ref : l >= ref; x2 = 0 <= ref ? ++l : --l) {
                if (arr[i2 - 1][x2] !== arr[i2][x2]) {
                  noDraw = false;
                }
              }
              if (noDraw) {
            ...
            len = 0;
            while (i2 + len < arr.length) {
              stop = false;
              for (x2 = n = 0, ref1 = j2; 0 <= ref1 ? n <= ref1 : n >= ref1; x2 = 0 <= ref1 ? ++n : --n) {
                if (arr[i2][x2] !== arr[i2 + len][x2]) {
                  stop = true;
                }
              }
              if (stop) {
