...
// node_modules/react-pivottable/PlotlyRenderers.js
var require_PlotlyRenderers = __commonJS({
  "node_modules/react-pivottable/PlotlyRenderers.js"(exports, module) {
    ...
    function makeRenderer(PlotlyComponent) {
      var traceOptions = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      var layoutOptions = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      var transpose = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
      var Renderer = function(_React$PureComponent) {
        _inherits(Renderer2, _React$PureComponent);
        function Renderer2() {
          _classCallCheck(this, Renderer2);
          return _possibleConstructorReturn(this, (Renderer2.__proto__ || Object.getPrototypeOf(Renderer2)).apply(this, arguments));
        }
    ...
    function makeScatterRenderer(PlotlyComponent) {
      var Renderer = function(_React$PureComponent2) {
        _inherits(Renderer2, _React$PureComponent2);
        function Renderer2() {
          _classCallCheck(this, Renderer2);
          return _possibleConstructorReturn(this, (Renderer2.__proto__ || Object.getPrototypeOf(Renderer2)).apply(this, arguments));
        }
...
export default require_PlotlyRenderers();
//# sourceMappingURL=react-pivottable_PlotlyRenderers.js.map
